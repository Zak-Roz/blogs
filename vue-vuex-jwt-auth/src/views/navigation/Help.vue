    ...
    <div class="row">
      ...
      <div class="col ml-5">
        ...
        <div class="card border-0" align="center">
          ...
          <p class="card-text">вул. Степана Бандери, 1, м. Київ, 04040</p>
          <h5 class="card-title mt-3 mb-2">Call-центр</h5>
          <p class="card-text">0-800-500-100</p>
          <h5 class="card-title mt-3 mb-2">Технічна підтримка</h5>
          <a class="card-text" href="mailto:example@gmail.com">example@gmail.com</a>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      email_subject: '',
      email_body: '',
      subjects: ["Проблеми з пошуком найближчою хімчисткою", "Проблеми з оновленням даних",
        "Проблеми зі створенням послуги", "Проблеми з реєстрацією у системі", "Проблеми з авторизацією у системі", "Інше"]
    };
  },
  methods: {
    handleEmail () {
